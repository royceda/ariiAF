    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/jid')) {
            ...
            if (preg_match('#^/jid/(?P<_locale>en|fr|es|de|cn|ar|ru|jp)/planned$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => 'arii_JID_planned')), array (  '_controller' => 'Arii\\JIDBundle\\Controller\\PlannedController::indexAction',));
            }
