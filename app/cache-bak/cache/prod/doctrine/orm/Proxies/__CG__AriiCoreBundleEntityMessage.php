 ...
 */
class Message extends \Arii\CoreBundle\Entity\Message implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'id', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'messageID', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'subject', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'content', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'status', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'time', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Message' . "\0" . 'notification');
        }
