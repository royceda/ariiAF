...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'arii.repository.connection' => 'getArii_Repository_ConnectionService',
            'arii_core.audit' => 'getAriiCore_AuditService',
            'arii_core.cron' => 'getAriiCore_CronService',
            'arii_core.date' => 'getAriiCore_DateService',
            'arii_core.db' => 'getAriiCore_DbService',
            'arii_core.dhtmlx' => 'getAriiCore_DhtmlxService',
            'arii_core.doc' => 'getAriiCore_DocService',
            'arii_core.exec' => 'getAriiCore_ExecService',
            'arii_core.files' => 'getAriiCore_FilesService',
            'arii_core.folder' => 'getAriiCore_FolderService',
            'arii_core.log' => 'getAriiCore_LogService',
            'arii_core.message' => 'getAriiCore_MessageService',
            'arii_core.portal' => 'getAriiCore_PortalService',
            'arii_core.session' => 'getAriiCore_SessionService',
            'arii_core.sos' => 'getAriiCore_SosService',
            'arii_core.sql' => 'getAriiCore_SqlService',
            'arii_core.tools' => 'getAriiCore_ToolsService',
            'arii_ds.dailyschedule' => 'getAriiDs_DailyscheduleService',
            'arii_ds.sos' => 'getAriiDs_SosService',
            'arii_focus.focus' => 'getAriiFocus_FocusService',
            'arii_jid.graphviz' => 'getAriiJid_GraphvizService',
            'arii_jid.history' => 'getAriiJid_HistoryService',
            'arii_jid.sos' => 'getAriiJid_SosService',
            'arii_joc.focus' => 'getAriiJoc_FocusService',
            'arii_joc.sos' => 'getAriiJoc_SosService',
            'arii_joc.state' => 'getAriiJoc_StateService',
            'arii_joc.treegrid' => 'getAriiJoc_TreegridService',
            'arii_locale.locale_listener' => 'getAriiLocale_LocaleListenerService',
            'arii_mft.history' => 'getAriiMft_HistoryService',
            'arii_mft.mft' => 'getAriiMft_MftService',
            'arii_mft.yade' => 'getAriiMft_YadeService',
            'arii_time.timecode' => 'getAriiTime_TimecodeService',
            'arii_user.oauth_user_provider' => 'getAriiUser_OauthUserProviderService',
            ...
            'report_import.ezv' => 'getReportImport_EzvService',
            'report_import.ipam' => 'getReportImport_IpamService',
    ...
    /**
     * Gets the 'arii.repository.connection' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Entity\Connection A Arii\CoreBundle\Entity\Connection instance.
     */
    protected function getArii_Repository_ConnectionService()
    {
        return $this->services['arii.repository.connection'] = $this->get('doctrine.orm.default_entity_manager')->getRepository('AriiCoreBundle:Connection');
    }

    /**
     * Gets the 'arii_core.audit' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiAudit A Arii\CoreBundle\Service\AriiAudit instance.
     */
    protected function getAriiCore_AuditService()
    {
        return $this->services['arii_core.audit'] = new \Arii\CoreBundle\Service\AriiAudit($this->get('arii_core.session'), $this->get('fos_user.user_manager'), $this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'arii_core.cron' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiCron A Arii\CoreBundle\Service\AriiCron instance.
     */
    protected function getAriiCore_CronService()
    {
        return $this->services['arii_core.cron'] = new \Arii\CoreBundle\Service\AriiCron($this->get('arii_core.session'));
    }

    /**
     * Gets the 'arii_core.date' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiDate A Arii\CoreBundle\Service\AriiDate instance.
     */
    protected function getAriiCore_DateService()
    {
        return $this->services['arii_core.date'] = new \Arii\CoreBundle\Service\AriiDate($this->get('arii_core.session'), $this->get('translator'));
    }

    /**
     * Gets the 'arii_core.db' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiDB A Arii\CoreBundle\Service\AriiDB instance.
     */
    protected function getAriiCore_DbService()
    {
        return $this->services['arii_core.db'] = new \Arii\CoreBundle\Service\AriiDB('mysqli', '127.0.0.1', NULL, 'arii', 'root', 'root');
    }

    /**
     * Gets the 'arii_core.dhtmlx' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiDHTMLX A Arii\CoreBundle\Service\AriiDHTMLX instance.
     */
    protected function getAriiCore_DhtmlxService()
    {
        return $this->services['arii_core.dhtmlx'] = new \Arii\CoreBundle\Service\AriiDHTMLX($this->get('arii_core.session'));
    }

    /**
     * Gets the 'arii_core.doc' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiDoc A Arii\CoreBundle\Service\AriiDoc instance.
     */
    protected function getAriiCore_DocService()
    {
        return $this->services['arii_core.doc'] = new \Arii\CoreBundle\Service\AriiDoc($this->get('request_stack'), ($this->targetDirs[4].'/jre/bin/java'), ($this->targetDirs[3].'/vendor/ditaa'), 'dot');
    }

    /**
     * Gets the 'arii_core.exec' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiExec A Arii\CoreBundle\Service\AriiExec instance.
     */
    protected function getAriiCore_ExecService()
    {
        return $this->services['arii_core.exec'] = new \Arii\CoreBundle\Service\AriiExec($this->get('arii_core.session'), ($this->targetDirs[4].'/workspace'), $this->get('arii_core.db'), $this->get('arii_core.sql'), $this->get('arii_core.audit'), $this->get('arii_core.log'));
    }

    /**
     * Gets the 'arii_core.files' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiFiles A Arii\CoreBundle\Service\AriiFiles instance.
     */
    protected function getAriiCore_FilesService()
    {
        return $this->services['arii_core.files'] = new \Arii\CoreBundle\Service\AriiFiles($this->get('arii_core.session'), ($this->targetDirs[4].'/workspace'));
    }

    /**
     * Gets the 'arii_core.folder' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiFolder A Arii\CoreBundle\Service\AriiFolder instance.
     */
    protected function getAriiCore_FolderService()
    {
        return $this->services['arii_core.folder'] = new \Arii\CoreBundle\Service\AriiFolder($this->get('arii_core.session'));
    }

    /**
     * Gets the 'arii_core.log' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiLog A Arii\CoreBundle\Service\AriiLog instance.
     */
    protected function getAriiCore_LogService()
    {
        return $this->services['arii_core.log'] = new \Arii\CoreBundle\Service\AriiLog($this->get('doctrine.orm.default_entity_manager'), $this->get('arii_core.session'));
    }

    /**
     * Gets the 'arii_core.message' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiMessage A Arii\CoreBundle\Service\AriiMessage instance.
     */
    protected function getAriiCore_MessageService()
    {
        return $this->services['arii_core.message'] = new \Arii\CoreBundle\Service\AriiMessage($this->get('doctrine.orm.default_entity_manager'));
    }

    /**
     * Gets the 'arii_core.portal' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiPortal A Arii\CoreBundle\Service\AriiPortal instance.
     */
    protected function getAriiCore_PortalService()
    {
        return $this->services['arii_core.portal'] = new \Arii\CoreBundle\Service\AriiPortal($this->get('arii_core.session'), $this->get('security.context'), $this->get('translator'), $this->get('router'));
    }

    /**
     * Gets the 'arii_core.session' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiSession A Arii\CoreBundle\Service\AriiSession instance.
     */
    protected function getAriiCore_SessionService()
    {
        return $this->services['arii_core.session'] = new \Arii\CoreBundle\Service\AriiSession($this->get('session'), $this, $this->get('arii_core.db'));
    }

    /**
     * Gets the 'arii_core.sos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiSOS A Arii\CoreBundle\Service\AriiSOS instance.
     */
    protected function getAriiCore_SosService()
    {
        return $this->services['arii_core.sos'] = new \Arii\CoreBundle\Service\AriiSOS($this->get('arii_core.audit'), $this->get('arii_core.log'));
    }

    /**
     * Gets the 'arii_core.sql' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiSQL A Arii\CoreBundle\Service\AriiSQL instance.
     */
    protected function getAriiCore_SqlService()
    {
        return $this->services['arii_core.sql'] = new \Arii\CoreBundle\Service\AriiSQL($this->get('arii_core.session'));
    }

    /**
     * Gets the 'arii_core.tools' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Service\AriiTools A Arii\CoreBundle\Service\AriiTools instance.
     */
    protected function getAriiCore_ToolsService()
    {
        return $this->services['arii_core.tools'] = new \Arii\CoreBundle\Service\AriiTools($this->get('arii_core.session'), ($this->targetDirs[4].'/workspace'));
    }

    /**
     * Gets the 'arii_ds.dailyschedule' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\DSBundle\Service\AriiDailySchedule A Arii\DSBundle\Service\AriiDailySchedule instance.
     */
    protected function getAriiDs_DailyscheduleService()
    {
        return $this->services['arii_ds.dailyschedule'] = new \Arii\DSBundle\Service\AriiDailySchedule($this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'), $this->get('arii_core.date'), $this->get('arii_core.tools'));
    }

    /**
     * Gets the 'arii_ds.sos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\DSBundle\Service\AriiSOS A Arii\DSBundle\Service\AriiSOS instance.
     */
    protected function getAriiDs_SosService()
    {
        return $this->services['arii_ds.sos'] = new \Arii\DSBundle\Service\AriiSOS($this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'));
    }

    /**
     * Gets the 'arii_focus.focus' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\FocusBundle\Service\AriiFocus A Arii\FocusBundle\Service\AriiFocus instance.
     */
    protected function getAriiFocus_FocusService()
    {
        return $this->services['arii_focus.focus'] = new \Arii\FocusBundle\Service\AriiFocus($this->get('arii_core.tools'), $this->get('arii_core.db'));
    }

    /**
     * Gets the 'arii_jid.graphviz' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JIDBundle\Service\AriiGraphviz A Arii\JIDBundle\Service\AriiGraphviz instance.
     */
    protected function getAriiJid_GraphvizService()
    {
        return $this->services['arii_jid.graphviz'] = new \Arii\JIDBundle\Service\AriiGraphviz($this->get('arii_core.tools'), $this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'));
    }

    /**
     * Gets the 'arii_jid.history' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JIDBundle\Service\AriiHistory A Arii\JIDBundle\Service\AriiHistory instance.
     */
    protected function getAriiJid_HistoryService()
    {
        return $this->services['arii_jid.history'] = new \Arii\JIDBundle\Service\AriiHistory($this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'), $this->get('arii_core.date'), $this->get('arii_core.tools'));
    }

    /**
     * Gets the 'arii_jid.sos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JIDBundle\Service\AriiSOS A Arii\JIDBundle\Service\AriiSOS instance.
     */
    protected function getAriiJid_SosService()
    {
        return $this->services['arii_jid.sos'] = new \Arii\JIDBundle\Service\AriiSOS($this->get('arii_core.session'), $this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'), $this->get('arii_core.audit'), $this->get('arii_core.log'));
    }

    /**
     * Gets the 'arii_joc.focus' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JOCBundle\Service\AriiFocus A Arii\JOCBundle\Service\AriiFocus instance.
     */
    protected function getAriiJoc_FocusService()
    {
        return $this->services['arii_joc.focus'] = new \Arii\JOCBundle\Service\AriiFocus($this->get('arii_core.tools'), $this->get('arii_core.db'));
    }

    /**
     * Gets the 'arii_joc.sos' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JOCBundle\Service\AriiSOS A Arii\JOCBundle\Service\AriiSOS instance.
     */
    protected function getAriiJoc_SosService()
    {
        return $this->services['arii_joc.sos'] = new \Arii\JOCBundle\Service\AriiSOS($this->get('arii_core.db'), $this->get('arii_core.sql'));
    }

    /**
     * Gets the 'arii_joc.state' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JOCBundle\Service\AriiState A Arii\JOCBundle\Service\AriiState instance.
     */
    protected function getAriiJoc_StateService()
    {
        return $this->services['arii_joc.state'] = new \Arii\JOCBundle\Service\AriiState($this->get('arii_core.db'), $this->get('arii_core.sql'), $this->get('arii_core.date'));
    }

    /**
     * Gets the 'arii_joc.treegrid' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JOCBundle\Service\AriiTreeGrid A Arii\JOCBundle\Service\AriiTreeGrid instance.
     */
    protected function getAriiJoc_TreegridService()
    {
        return $this->services['arii_joc.treegrid'] = new \Arii\JOCBundle\Service\AriiTreeGrid();
    }

    /**
     * Gets the 'arii_locale.locale_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\EventListener\LocaleListener A Arii\CoreBundle\EventListener\LocaleListener instance.
     */
    ...
    /**
     * Gets the 'arii_mft.history' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\MFTBundle\Service\AriiHistory A Arii\MFTBundle\Service\AriiHistory instance.
     */
    protected function getAriiMft_HistoryService()
    {
        return $this->services['arii_mft.history'] = new \Arii\MFTBundle\Service\AriiHistory($this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'), $this->get('arii_core.date'), $this->get('arii_core.tools'));
    }

    /**
     * Gets the 'arii_mft.mft' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\MFTBundle\Service\AriiMFT A Arii\MFTBundle\Service\AriiMFT instance.
     */
    protected function getAriiMft_MftService()
    {
        return $this->services['arii_mft.mft'] = new \Arii\MFTBundle\Service\AriiMFT($this->get('arii_core.db'), $this->get('arii_core.sql'), $this->get('arii_core.date'), 'mysqli');
    }

    /**
     * Gets the 'arii_mft.yade' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\MFTBundle\Service\AriiYade A Arii\MFTBundle\Service\AriiYade instance.
     */
    protected function getAriiMft_YadeService()
    {
        return $this->services['arii_mft.yade'] = new \Arii\MFTBundle\Service\AriiYade($this->get('arii_core.dhtmlx'), $this->get('arii_core.sql'), $this->get('arii_core.date'), $this->get('arii_core.tools'));
    }

    /**
     * Gets the 'arii_time.timecode' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\TimeBundle\Service\AriiTimecode A Arii\TimeBundle\Service\AriiTimecode instance.
     */
    protected function getAriiTime_TimecodeService()
    {
        return $this->services['arii_time.timecode'] = new \Arii\TimeBundle\Service\AriiTimecode();
    }

    /**
     * Gets the 'arii_user.oauth_user_provider' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\UserBundle\Model\OAuthUserProvider A Arii\UserBundle\Model\OAuthUserProvider instance.
     */
    protected function getAriiUser_OauthUserProviderService()
    {
    ...
    /**
     * Gets the 'core.twig.core_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\CoreBundle\Twig\CoreExtension A Arii\CoreBundle\Twig\CoreExtension instance.
     */
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addSubscriberService('arii_locale.locale_listener', 'Arii\\CoreBundle\\EventListener\\LocaleListener');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'arii', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => ($this->targetDirs[3].'/src/Arii/UserBundle/Entity'), 1 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Entity'), 2 => ($this->targetDirs[3].'/src/Arii/GraphvizBundle/Entity'), 3 => ($this->targetDirs[3].'/src/Arii/TimeBundle/Entity'), 4 => ($this->targetDirs[3].'/src/Arii/ReportBundle/Entity'), 5 => ($this->targetDirs[3].'/src/Arii/MFTBundle/Entity'), 6 => ($this->targetDirs[3].'/src/Arii/FocusBundle/Entity'), 7 => ($this->targetDirs[3].'/src/Arii/JOCBundle/Entity')));

        $c = new \Doctrine\Common\Persistence\Mapping\Driver\MappingDriverChain();
        $c->addDriver($b, 'Arii\\UserBundle\\Entity');
        $c->addDriver($b, 'Arii\\CoreBundle\\Entity');
        $c->addDriver($b, 'Arii\\GraphvizBundle\\Entity');
        $c->addDriver($b, 'Arii\\TimeBundle\\Entity');
        $c->addDriver($b, 'Arii\\ReportBundle\\Entity');
        $c->addDriver($b, 'Arii\\MFTBundle\\Entity');
        $c->addDriver($b, 'Arii\\FocusBundle\\Entity');
        $c->addDriver($b, 'Arii\\JOCBundle\\Entity');
        ...
        $d->setEntityNamespaces(array('AriiUserBundle' => 'Arii\\UserBundle\\Entity', 'AriiCoreBundle' => 'Arii\\CoreBundle\\Entity', 'AriiGraphvizBundle' => 'Arii\\GraphvizBundle\\Entity', 'AriiTimeBundle' => 'Arii\\TimeBundle\\Entity', 'AriiReportBundle' => 'Arii\\ReportBundle\\Entity', 'AriiMFTBundle' => 'Arii\\MFTBundle\\Entity', 'AriiFocusBundle' => 'Arii\\FocusBundle\\Entity', 'AriiJOCBundle' => 'Arii\\JOCBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_aa417b7d14cb7620fa434e5b395dcd4b410a36dd81391769740ff5939d11fcf4');
    ...
    {
        return $this->services['fos_user.change_password.form.type'] = new \FOS\UserBundle\Form\Type\ChangePasswordFormType('Arii\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.profile.form.type'] = new \FOS\UserBundle\Form\Type\ProfileFormType('Arii\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.registration.form.type'] = new \FOS\UserBundle\Form\Type\RegistrationFormType('Arii\\UserBundle\\Entity\\User');
    }
    ...
    {
        return $this->services['fos_user.resetting.form.type'] = new \FOS\UserBundle\Form\Type\ResettingFormType('Arii\\UserBundle\\Entity\\User');
    }
    ...
    protected function getFosUser_UserManagerService()
    {
        ...
        return $this->services['fos_user.user_manager'] = new \FOS\UserBundle\Doctrine\UserManager($this->get('security.encoder_factory'), $a, $a, $this->get('doctrine')->getManager(NULL), 'Arii\\UserBundle\\Entity\\User');
    }
    ...
    /**
     * Gets the 'jid.twig.jid_extension' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\JIDBundle\Twig\JIDExtension A Arii\JIDBundle\Twig\JIDExtension instance.
     */
    ...
    /**
     * Gets the 'report_import.ezv' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\ReportBundle\Service\ImportEZV A Arii\ReportBundle\Service\ImportEZV instance.
     */
    protected function getReportImport_EzvService()
    {
        return $this->services['report_import.ezv'] = new \Arii\ReportBundle\Service\ImportEZV($this->get('doctrine.orm.default_entity_manager'), (($this->hasParameter("Report")) ? ($this->getParameter("Report")) : ("")));
    }

    /**
     * Gets the 'report_import.ipam' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Arii\ReportBundle\Service\ImportIPAM A Arii\ReportBundle\Service\ImportIPAM instance.
     */
    protected function getReportImport_IpamService()
    {
        return $this->services['report_import.ipam'] = new \Arii\ReportBundle\Service\ImportIPAM($this->get('doctrine.orm.default_entity_manager'), (($this->hasParameter("Report")) ? ($this->getParameter("Report")) : ("")));
    }
    ...
    {
        return $this->services['security.firewall'] = new \Symfony\Component\Security\Http\Firewall(new \Symfony\Bundle\SecurityBundle\Security\FirewallMap($this, array('security.firewall.map.context.login' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(login$|register|resetting|sync_state)'), 'security.firewall.map.context.dev' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(_(profiler|wdt)|css|images|js)/'), 'security.firewall.map.context.user' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/(user)/'), 'security.firewall.map.context.public' => new \Symfony\Component\HttpFoundation\RequestMatcher('/(public)/'), 'security.firewall.map.context.main' => new \Symfony\Component\HttpFoundation\RequestMatcher('^/'))), $this->get('debug.event_dispatcher'));
    }
    ...
    protected function getSecurity_Firewall_Map_Context_MainService()
    {
        ...
        $c = $this->get('security.user.provider.concrete.chain_provider');
        ...
        $n = new \Symfony\Component\Security\Http\RememberMe\TokenBasedRememberMeServices(array(0 => $c), '8cfa2bd0b50b7db00e9c186be68f7ce7465123d3', 'main', array('remember_me_parameter' => 'login[remember_me]', 'name' => 'REMEMBERME', 'lifetime' => 31536000, 'path' => '/', 'domain' => NULL, 'secure' => false, 'httponly' => true, 'always_remember_me' => false), $a);
        ...
        $p->setOptions(array('use_referer' => true, 'default_target_path' => 'arii_Home_index', 'always_use_default_target_path' => false, 'login_path' => '/login', 'target_path_parameter' => '_target_path'));
        ...
        return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(0 => new \Symfony\Component\Security\Http\Firewall\ChannelListener($l, new \Symfony\Component\Security\Http\EntryPoint\RetryAuthenticationEntryPoint(80, 443), $a), 1 => new \Symfony\Component\Security\Http\Firewall\ContextListener($b, array(0 => $c, 1 => $this->get('security.user.provider.concrete.in_memory'), 2 => $this->get('fos_user.user_provider.username')), 'main', $a, $d), 2 => $o, 3 => $r, 4 => new \Symfony\Component\Security\Http\Firewall\RememberMeListener($b, $n, $g, $a, $d, true), 5 => new \Symfony\Component\Security\Http\Firewall\AccessListener($b, $this->get('security.access.decision_manager'), $l, $g)), new \Symfony\Component\Security\Http\Firewall\ExceptionListener($b, $this->get('security.authentication.trust_resolver'), $m, 'main', new \Symfony\Component\Security\Http\EntryPoint\FormAuthenticationEntryPoint($f, $m, '/login', false), NULL, NULL, $a, false));
    }
    ...
    {
        return $this->services['security.firewall.map.context.user'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(array(), NULL);
    }
    ...
    {
        $this->services['translator.default'] = $instance = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, new \Symfony\Component\Translation\MessageSelector(), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => (__DIR__.'/translations'), 'debug' => true, 'resource_files' => array('nl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.nl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.nl.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.nl.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nl.yml')), 'ja' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ja.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ja.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ja.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ja.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ja.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ja.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ja.yml')), 'ro' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ro.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ro.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ro.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ro.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ro.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ro.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ro.yml')), 'sv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sv.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sv.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sv.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sv.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sv.yml')), 'he' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.he.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.he.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.he.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.he.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.he.yml')), 'sr_Latn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Latn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Latn.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Latn.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sr_Latn.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sr_Latn.yml')), 'es' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.es.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.es.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.es.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.es.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.es.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.es.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.es.yml'), 7 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.es.yml')), 'uk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.uk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.uk.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.uk.xliff'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.uk.xliff'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.uk.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.uk.yml')), 'fi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fi.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fi.xliff'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fi.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fi.yml')), 'gl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.gl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.gl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.gl.xlf')), 'zh_CN' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_CN.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.zh_CN.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.zh_CN.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.zh_CN.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.zh_CN.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.zh_CN.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.zh_CN.yml')), 'fr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fr.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fr.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.fr.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fr.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fr.yml'), 7 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.fr.yml'), 8 => ($this->targetDirs[3].'/src/Arii/TimeBundle/Resources/translations/messages.fr.yml'), 9 => ($this->targetDirs[3].'/src/Arii/MFTBundle/Resources/translations/messages.fr.yml'), 10 => ($this->targetDirs[3].'/src/Arii/FocusBundle/Resources/translations/messages.fr.yml'), 11 => ($this->targetDirs[3].'/src/Arii/DSBundle/Resources/translations/messages.fr.xlf')), 'hr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hr.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hr.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.hr.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.hr.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hr.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hr.yml')), 'el' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.el.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.el.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.el.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.el.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.el.yml')), 'az' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.az.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.az.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.az.xlf')), 'en' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.en.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.en.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.en.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.en.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.en.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.en.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.en.yml'), 7 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.en.yml'), 8 => ($this->targetDirs[3].'/src/Arii/FocusBundle/Resources/translations/messages.en.yml')), 'hu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hu.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.hu.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.hu.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.hu.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.hu.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.hu.yml')), 'de' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.de.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.de.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.de.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.de.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.de.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.de.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.de.yml'), 7 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.de.yml')), 'vi' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.vi.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.vi.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.vi.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.vi.yml')), 'pt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pt.xliff'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pt.xliff'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt.yml')), 'id' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.id.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.id.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.id.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.id.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.id.yml')), 'pt_BR' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pt_BR.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pt_BR.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_BR.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pt_BR.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pt_BR.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pt_BR.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pt_BR.yml')), 'ar' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ar.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ar.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ar.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ar.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ar.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ar.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ar.yml'), 7 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.ar.yml')), 'ca' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ca.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ca.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ca.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ca.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ca.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ca.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ca.yml')), 'da' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.da.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.da.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.da.xlf'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.da.yml'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.da.yml')), 'th' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.th.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.th.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.th.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.th.yml')), 'nb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.nb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.nb.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.nb.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.nb.yml')), 'fa' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.fa.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.fa.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.fa.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.fa.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.fa.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.fa.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.fa.yml')), 'cs' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cs.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.cs.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.cs.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.cs.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.cs.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.cs.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.cs.yml')), 'lt' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lt.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lt.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lt.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.lt.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.lt.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lt.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lt.yml')), 'sr_Cyrl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sr_Cyrl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sr_Cyrl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sr_Cyrl.xlf')), 'zh_TW' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.zh_TW.xlf')), 'lb' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.lb.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lb.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.lb.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.lb.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.lb.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lb.yml')), 'sl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.sl.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sl.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sl.yml')), 'ru' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.ru.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.ru.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ru.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.ru.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.ru.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.ru.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.ru.yml')), 'af' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.af.xlf')), 'pl' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.pl.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.pl.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pl.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.pl.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.pl.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.pl.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.pl.yml')), 'eu' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.eu.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.eu.xlf'), 2 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.eu.xliff'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.eu.xliff'), 4 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.eu.yml'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.eu.yml')), 'mn' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.mn.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.mn.xlf')), 'it' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.it.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.it.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.it.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.it.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.it.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.it.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.it.yml')), 'no' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.no.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.no.xlf')), 'hy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.hy.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.hy.xlf')), 'sq' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sq.xlf')), 'bg' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.bg.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.bg.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.bg.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.bg.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.bg.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.bg.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.bg.yml')), 'et' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.et.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.et.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.et.yml')), 'tr' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.tr.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.tr.xlf'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.tr.yml'), 3 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.tr.yml')), 'sk' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.sk.xlf'), 1 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.sk.xlf'), 2 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.sk.xlf'), 3 => ($this->targetDirs[3].'/vendor/sonata-project/core-bundle/Resources/translations/SonataCoreBundle.sk.xliff'), 4 => ($this->targetDirs[3].'/vendor/sonata-project/admin-bundle/Resources/translations/SonataAdminBundle.sk.xliff'), 5 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.sk.yml'), 6 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.sk.yml')), 'cy' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Validator/Resources/translations/validators.cy.xlf')), 'lv' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/translations/validators.lv.xlf'), 1 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/FOSUserBundle.lv.yml'), 2 => ($this->targetDirs[3].'/vendor/friendsofsymfony/user-bundle/Resources/translations/validators.lv.yml')), 'ua' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.ua.xlf')), 'pt_PT' => array(0 => ($this->targetDirs[3].'/vendor/symfony/symfony/src/Symfony/Component/Security/Core/Exception/../Resources/translations/security.pt_PT.xlf')), 'cn' => array(0 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.cn.yml')), 'jp' => array(0 => ($this->targetDirs[3].'/src/Arii/CoreBundle/Resources/translations/messages.jp.yml')))), array());
    ...
    protected function getTwigService()
    {
        ...
        $instance->addExtension($this->get('core.twig.core_extension'));
        $instance->addExtension($this->get('jid.twig.jid_extension'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Arii/ToolsBundle/Resources/views'), 'AriiTools');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Arii/JOEBundle/Resources/views'), 'AriiJOE');
        $instance->addPath(($this->targetDirs[3].'/src/Arii/TimeBundle/Resources/views'), 'AriiTime');
        $instance->addPath(($this->targetDirs[3].'/src/Arii/ReportBundle/Resources/views'), 'AriiReport');
        $instance->addPath(($this->targetDirs[3].'/src/Arii/MFTBundle/Resources/views'), 'AriiMFT');
        $instance->addPath(($this->targetDirs[3].'/src/Arii/FocusBundle/Resources/views'), 'AriiFocus');
        ...
        $instance->addPath(($this->targetDirs[3].'/src/Arii/GitBundle/Resources/views'), 'AriiGit');
    ...
    {
        return $this->services['security.role_hierarchy'] = new \Symfony\Component\Security\Core\Role\RoleHierarchy(array('ROLE_ADMIN' => array(0 => 'ROLE_SYSADMIN', 1 => 'ROLE_OPERATOR', 2 => 'ROLE_DEVELOPPER'), 'ROLE_MANAGER' => array(0 => 'ROLE_USER', 1 => 'ROLE_OPERATOR', 2 => 'ROLE_DEVELOPPER'), 'ROLE_OPERATOR' => array(0 => 'ROLE_USER'), 'ROLE_DEVELOPPER' => array(0 => 'ROLE_USER'), 'ROLE_SYSADMIN' => array(0 => 'ROLE_ALLOWED_TO_SWITCH', 1 => 'ROLE_DEVELOPPER')));
    }
    ...
    {
        return $this->services['security.user.provider.concrete.chain_provider'] = new \Symfony\Component\Security\Core\User\ChainUserProvider(array(0 => $this->get('fos_user.user_provider.username'), 1 => $this->get('security.user.provider.concrete.in_memory')));
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'AriiToolsBundle' => 'Arii\\ToolsBundle\\AriiToolsBundle',
                'AriiGraphvizBundle' => 'Arii\\GraphvizBundle\\AriiGraphvizBundle',
                'AriiJIDBundle' => 'Arii\\JIDBundle\\AriiJIDBundle',
                'AriiJOEBundle' => 'Arii\\JOEBundle\\AriiJOEBundle',
                'AriiTimeBundle' => 'Arii\\TimeBundle\\AriiTimeBundle',
                'AriiReportBundle' => 'Arii\\ReportBundle\\AriiReportBundle',
                'AriiMFTBundle' => 'Arii\\MFTBundle\\AriiMFTBundle',
                'AriiFocusBundle' => 'Arii\\FocusBundle\\AriiFocusBundle',
                'AriiJOCBundle' => 'Arii\\JOCBundle\\AriiJOCBundle',
                'AriiDSBundle' => 'Arii\\DSBundle\\AriiDSBundle',
                'AriiGitBundle' => 'Arii\\GitBundle\\AriiGitBundle',
            ...
            'workspace' => ($this->targetDirs[4].'/workspace'),
            'packages' => ($this->targetDirs[4].'/workspace/packages'),
            'perl' => 'perl',
            'java' => ($this->targetDirs[4].'/jre/bin/java'),
            'ditaa' => ($this->targetDirs[3].'/vendor/ditaa'),
            'databases' => array(
                0 => array(
                    'name' => 'Ari\'i',
                    'dbname' => 'arii',
                ...
                0 => array(
                    ...
                    0 => array(
                        'shell' => array(
                            ...
                            'user' => 'arii',
                            'host' => 'localhost',
                            'home' => ($this->targetDirs[4].'/jobscheduler/arii'),
                            'data' => ($this->targetDirs[4].'/jobscheduler/arii'),
                        ),
                        'rest' => array(
                            'host' => 'localhost',
                            'port' => 44444,
            ...
            'osjs_config' => ($this->targetDirs[4].'/jobscheduler/arii/config'),
            'graphviz_dot' => 'dot',
            'graphviz_images' => ($this->targetDirs[3].'/web/arii/images/silk'),
            'report_path' => ($this->targetDirs[4].'/jobscheduler/arii/config/reports/output'),
            'charset' => 'UTF-8',
