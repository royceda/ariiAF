 ...
 */
class Audit extends \Arii\CoreBundle\Entity\Audit implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'user', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'id', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'logtime', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'ip', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'action', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'message', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'status', '' . "\0" . 'Arii\\CoreBundle\\Entity\\Audit' . "\0" . 'module');
        }
