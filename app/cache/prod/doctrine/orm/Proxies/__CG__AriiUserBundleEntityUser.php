...
namespace Proxies\__CG__\Arii\UserBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class User extends \Arii\UserBundle\Entity\User implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', '' . "\0" . 'Arii\\UserBundle\\Entity\\User' . "\0" . 'last_name', '' . "\0" . 'Arii\\UserBundle\\Entity\\User' . "\0" . 'first_name', '' . "\0" . 'Arii\\UserBundle\\Entity\\User' . "\0" . 'team', '' . "\0" . 'Arii\\UserBundle\\Entity\\User' . "\0" . 'enterprise', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'locked', 'expired', 'expiresAt', 'roles', 'credentialsExpired', 'credentialsExpireAt');
        }
