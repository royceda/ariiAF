 ...
 */
class TeamFilter extends \Arii\CoreBundle\Entity\TeamFilter implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'team', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'filter', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'name', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'description', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'R', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'W', '' . "\0" . 'Arii\\CoreBundle\\Entity\\TeamFilter' . "\0" . 'X');
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TeamFilter $proxy) {
