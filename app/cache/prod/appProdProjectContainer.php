...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['arii_core.date'] = new \Arii\CoreBundle\Service\AriiDate($this->get('arii_core.session'), $this->get('translator.default'));
    }
    ...
    {
        return $this->services['arii_core.portal'] = new \Arii\CoreBundle\Service\AriiPortal($this->get('arii_core.session'), $this->get('security.context'), $this->get('translator.default'), $this->get('router'));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'arii', 'user' => 'root', 'password' => 'root', 'charset' => 'UTF8', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), $a, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_75f2a7db4d243823334d74cd5e53039285b8ea4145eb0401d225a06b49c05e09');
        return $instance;
    }
